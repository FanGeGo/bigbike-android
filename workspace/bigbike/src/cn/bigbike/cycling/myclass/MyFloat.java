...
import cn.bigbike.cycling.ui.MainActivity;
...
public class MyFloat {
	...
	public MyFloat(Context context, BigApp bigApp) {
	...
	public void refreshFloatView(){
		...
		speedNow.setText( df.format(bigApp.localService.mCont.speedNow) );
		speedAvg.setText( df.format(bigApp.localService.mCont.todaySpeedAvg) );
		mileage.setText( df.format(bigApp.localService.mCont.todayMileage) );
	}
