...
public class DynamicListView extends ListView implements OnScrollListener {
	...
	class StatusView extends LinearLayout {
		...
		private void initThis(Context context) {
			...
			View view = inflater.inflate(R.layout.listview_refresh_more, null);

			progressBar = (ProgressBar) view.findViewById(R.id.dynamic_listview_refresh_more_progress);
			textView = (TextView) view.findViewById(R.id.dynamic_listview_refresh_more_text);
	...
	public void onScroll(AbsListView l, int t, int oldl, int count) {
		...
		else if ( t+oldl == count-(doMoreWhenBottom?5:0) ) {
